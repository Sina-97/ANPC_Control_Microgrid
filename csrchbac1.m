function [up_delta,J,dJdu_old,dJdu,retcode1,delta,tol] = csrchbac1(up,u_vec,ref,Ai,Nu,N1,N2,d,Ni,Nj,dX, ...
...
[JJ,dJJ]=calcjjdjj1(u_vec,Ni,Nu,Nj,N2,Ai,Ts,ref,tiu,rho,dUtilde_dU,Normalize,minp,maxp);
perfb = JJ;
dJdub = dJJ;
